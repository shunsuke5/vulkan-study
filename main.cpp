...
private:
    ...
    VkCommandBuffer commandBuffer;                      // コマンドバッファ
    VkSemaphore imageAvailableSemaphore;                // イメージ利用可能セマフォ
    VkSemaphore renderFinishedSemaphore;                // 描画完了セマフォ
    VkFence inFlightFence;                              // フェンス
